...
public class ContactsServiceImpl implements IService<Contacts> {
    ...
    public String FILE_PATH = "/Users/manhcao/Downloads/TestModule2-master/src/file";
    ...
    public void readFile() {
        try {
            ...
            while ((line = bufferedReader.readLine()) != null){
                ...
                String dateOfBirth = contactsLine[5];
                String email = contactsLine[6];

                Contacts contacts = new Contacts(phone,group,name,gender,address,dateOfBirth,email);
                save(contacts);
            }
//            dateOfBirth, String email
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
