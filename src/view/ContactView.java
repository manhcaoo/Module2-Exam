        ...
        while (true){
            ...
            switch (choice){
                ...
                case 2:
                    viewAddContact();
                    break;
                case 3:viewEdditContact();
                    break;
                case 4:viewDeleteContact();
                    break;
                case 5:searchListContact();
                    break;
                case 6:contactsController.readFile();
                    break;
                case 7:contactsController.writeToFile();
                    break;
                case 8:
                    return;
            }
    ...
    public void viewDeleteContact (){
        ...
        while (true) {
            ...
            if (index > -1) {
                ...
                String option = Regex.validateNotNull("Phone not found, Please enter any key to re-enter phone or enter Quit to back menu","option is not null");
